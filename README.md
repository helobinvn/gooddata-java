# GoodData Java SDK
[![Build Status](https://github.com/helobinvn/gooddata-java/actions/workflows/pre-merge.yml/badge.svg?branch=master)](https://github.com/helobinvn/gooddata-java/actions/workflows/pre-merge.yml)
